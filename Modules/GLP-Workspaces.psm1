...
Function Remove-HPEGLWorkspace {
    ...
    .DESCRIPTION
    This cmdlet deletes the currently connected workspace from HPE GreenLake. You cannot delete a workspace if you are not connected to it. 
    
    IMPORTANT: This action will permanently and irrecoverably delete all data associated with the workspace from HPE GreenLake and will automatically 
    terminate your and all other sessions within the workspace.
...
Function Test-HPEGLDomain {
    ...
    Process {       
        ...
        try {
            ...
            if (-not $WhatIf) {
                $objStatus.Status = "Failed"
                $objStatus.Details = "Domain cannot be verified!"
                $objStatus.Exception = $Global:HPECOMInvokeReturnData
            }
        }
    ...
    Process {       
        ...
        if (-not $DomainId) {
            ...
            try {
                ...
                if (-not $WhatIf) {
                    $objStatus.Status = "Failed"
                    $objStatus.Details = "Domain cannot be removed!"
                    $objStatus.Exception = $Global:HPECOMInvokeReturnData
                }
            }
        }
            ...
            try {
                ...
                if ($Global:HPECOMInvokeReturnData.StatusCode -eq 400) {
                    ...
                    if ($WhatIf) {
                        ...
                        $objStatus.Status = "Failed"
                        $objStatus.Details = "The IdP Metadata URL cannot be validated! Please check the URL." 
        ...
        if ($FileFound) {   
            ...
            try {
                ...
                if ($Global:HPECOMInvokeReturnData.StatusCode -eq 409) {
                    ...
                    if (-not $WhatIf) {
                        $objStatus.Status = "Failed"
                        $objStatus.Details = "SSO connection cannot be added!"
                        $objStatus.Exception = $Global:HPECOMInvokeReturnData
                    }
                }
...
Function Set-HPEGLSSOConnection {
    ...
    Process {        
        ...
        try {
            ...
            if (-not $WhatIf) {
                $objStatus.Status = "Failed"
                $objStatus.Details = "SSO connection cannot be updated!"
                $objStatus.Exception = $Global:HPECOMInvokeReturnData
            }
        }
    ...
    Process {
        ...
        if (-not $SSOConnectionId) {
            ...
            try {
                ...
                if (-not $WhatIf) {
                    $objStatus.Status = "Failed"
                    $objStatus.Details = "SSO connection cannot be removed!"
                    $objStatus.Exception = $Global:HPECOMInvokeReturnData
                    [void] $DeleteStatus.add($objStatus)
                }
...
Function New-HPEGLSSOAuthenticationPolicy {
    ...
    Process {        
        ...
        if (-not $ExistingRecoveryUser) {
            ...
            if (-not $RecoveryAccountSecurePassword) {
                ...
                try {
                    ...
                    if (-not $WhatIf) {
                        $objStatus.Status = "Failed"
                        $objStatus.Details = "Recovery account cannot be added!"
                        $objStatus.Exception = $Global:HPECOMInvokeReturnData
                        [void] $AddAuthPolicyStatus.Add($objStatus)
                        return
                    }
        ...
        try {
            ...
            if (-not $WhatIf) {
                $objStatus.Status = "Failed"
                $objStatus.Details = "SSO Authentication policy cannot be added!"
                $objStatus.Exception = $Global:HPECOMInvokeReturnData
            }
        }
    ...
    Process {
        ...
        if (-not $AuthenticationPolicyId) {
            ...
            try {
                ...
                if (-not $WhatIf) {
                    $objStatus.Status = "Failed"
                    $objStatus.Details = "Authentication policy cannot be removed!"
                    $objStatus.Exception = $Global:HPECOMInvokeReturnData 
                    [void] $DeleteStatus.add($objStatus)
                }
                ...
                elseif ( $ExistingPolicy.action.authSource -eq $SSOConnectionObj.id ) {
                    ...
                    try {
                        ...
                        if (-not $WhatIf) {
                            ...
                            $objStatus.Status = "Failed"
                            $objStatus.Details = "Authentication policy cannot be updated!"
                            $objStatus.Exception = $Global:HPECOMInvokeReturnData
                        }
                    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD60ttIa2dO3N5U
# b/J/4/1e2hB6d1tHNDJzgx2/lCcGlKCCEfYwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
