...
Function Get-HPECOMServer {
    ...
    Optional switch parameter that filters the output to display only servers that are currently in maintenance mode. 
    Maintenance mode suspends automatic support case creation, ServiceNow incident creation, and email notifications for a server during planned maintenance.
    ...
    Lists all servers in the central EU region that are currently in maintenance mode.
    ...
    Process {
        ...
        if ($InMaintenanceMode) {
            ...
            if ($Uri -match "\?filter=" ) {
                ...
                $Uri = $Uri + " and maintenanceMode eq true"

            }
            else {
                $Uri = $Uri + "?filter=maintenanceMode eq true"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgJucuzQNdG9Mb
# PUVqvso1sNfBhUljXioyMBBpVVL5ZKCCEfYwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# IgQgVI4xZJGzfJUMhePLpWrFP8sThK+3VCVC2M65VNIm3J0wDQYJKoZIhvcNAQEB
# BQAEggIAnFokc4xOjTPXCffak8FIph34sGNvM7TYO4cNVqbRgRDFT0Kr3MNFp/RZ
# en2MVfinobjdAyq7tYZV2N4VnuQ/0Axddl4uCYuZO+PsOsGf+Na8r+jEo4qpop/h
# Qq59Des/GEu+hPmMFWqAUvvEyIIlMOxqN+Yc5FZOaeaUY+n3UmQAlWLeoy7Yq6GP
# H6y857kKfl8iT63SvNGYvY1z97oZ6nkn0TkT5lXGOqR1rSjE4kUvOo89soDr8okD
# CzlqONUudal/HU/BDtcQmJeTnyHAQqKuSPi5zG40YQFDyZ+lwsSpSHJgJt/y2z1L
# 4L9JJDWpj7cmdjxE5KJq1iVr+ZepscGPjDtKfantW+uEnI6f0M7MzBJxHkYOgBts
# BzjeDWyGFR9eKLj2wNQz/lQ6pmshumvrlUgILX+60E7s98qugnswwGjWhor2nFxT
# 3775M6PSu41MTb0aoGEQGJrNx9l41mST5/DHG7zHp/did4hHvtZzpCW7QsH/sDVl
# jhff9yUZaBHZhOlRM66XrFK7nXcdKXOXCZqnIqBkNZrZt37Kor9WqzUcK5ympmNN
# HTwLEOt+RFmfSNKSel6ADnNofHrnb2F4nPzhbSM5gyBalkEn+L0U7cgX+Bz/ICGT
# WQjKb/KwKievW3189T0K4rZRj9wZq0iz0j89wP/TgMswz6c9Kfahghn8MIIZ+AYK
...
# AQEwQTANBglghkgBZQMEAgIFAAQw0sbHrp+nbCTT1bx/oHkl5+3Iw5xPL5LFzk58
# D4tGF2obe7f2VRuGx002URz1F82yAhRLFpkXjRSVk4urFkBZ+Srmh8ferBgPMjAy
# NjA2MjYxMzQ1MTNaoHakdDByMQswCQYDVQQGEwJHQjEXMBUGA1UECBMOR3JlYXRl
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA2MjYxMzQ1
# MTNaMD8GCSqGSIb3DQEJBDEyBDB1PrFjmBwJD9JBfDMXiSlPNFt9ctecG6NKc7bU
# UIfDhs3WAv1v1Hmyz0LjLfzZIkwwggF7BgsqhkiG9w0BCRACDDGCAWowggFmMIIB
...
# eQIQNsKwvXwbOuejs902y8l1aDANBgkqhkiG9w0BAQEFAASCAgBhZL3E0M1lVz03
# dZSLhx5uX0+xe/s/leWMlWMyUoW/NMvNhcL33Aoep8FINSg9x+xuiUqdcxo1xjt/
# +4vvUPUQp5e5oiBsRndyiXrxklpAYErM8E6Bymu9pDtpHwmihrLWp/ENBA02gOxd
# Meug40W5IgBF/GiN8ig4zQwnwBqzVE20WI9M2HK0CrUE+CRvtFpgvgFXuVh1FQgh
# jtcUg2rkTZgwjnzLxib8evVsQBAu3VMcJhw//zNjIW85gjnas5k8gc0puUC9/JBS
# REMOrgIs4dWBNq5rPzfmUDZ/aydwGFln7/ietSGw3zhIxzHtDPbXwZIETXXiVQpJ
# bbs9kzfzhuY0QhHuGyyYzjYX48BcufePEtBqUdrNxH7O+wob9teqOGInZ3paT8c1
# e2ADTvOpa0S5g6AMREpR87rMsB4Cct9/yi1fusNQktJ/OGj2YRxq6pKi7axfAyNT
# pGNGxL861MxE/UEHCli5pXJZJGW+IMqRu2bWT0Qo7l7wZgWCPUVtD/YDJIeXRnyL
# fE5+yBPJlXagERW2H+iN/gSB+bjAx69Rdg0pmZPiEdi4cbVFCbzriGmt9V5Q21MR
# Q9SJ0DK/fg2uQfc3hTNlTM+jJ5YlbVYhCDjUt9COJMX6AYE/7q143UlGMt/st4Si
# GLZMGd95X439fduOFG9PICizv+c4Kg==
